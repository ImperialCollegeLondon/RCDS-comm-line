...
## Further study
- Local tutorials (ICL access only) - [Bash fundamentals](https://wiki.imperial.ac.uk/display/HPC/Command+line),[Bash scripting](https://wiki.imperial.ac.uk/display/HPC/Shell+scripting) - systematic with lots of examples
