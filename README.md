...
## Further study
- Local tutorials - systematic with lots of examples (ICL access only) - [Bash fundamentals](https://icl-rcs-user-guide.readthedocs.io/en/latest/support/using-linux/command-line/), [Bash scripting](https://icl-rcs-user-guide.readthedocs.io/en/latest/support/using-linux/shell-scripting/) 
